...
import type { ExpenseSelectViewResponse } from "../types";


export const ExpenseDetailView = forwardRef<DataModalButtons, DataModalComponentProps<ExpenseSelectViewResponse>>(({ data }, _ref) => {
    return (
